...
public class TodoController {
	...
	public ResponseEntity<TodoVO> getTodo(@PathVariable("team_num") int team_num, @PathVariable("todo_num") int todo_num){
	...
	//team_num필요
	@PutMapping("/{todo_num}")
	public ResponseEntity<Integer> updateTodo(@PathVariable("team_num") int team_num, @PathVariable("todo_num") int todo_num,@RequestBody TodoVO todo){
	...
	public ResponseEntity<Integer> deleteTodo(@PathVariable("team_num") int team_num, @PathVariable("todo_num") int todo_num){
